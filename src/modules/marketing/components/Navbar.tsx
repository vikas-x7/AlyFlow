  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 w-full text-white font-gothic mask-[linear-gradient(to_bottom,black_70%,transparent_100%)] bg-white ">
        <Topbar />
        <div className="py-3 md:pb-10 flex items-center justify-between w-full md:max-w-[80%] mx-auto relative">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="md:hidden z-50 p-1 text-xl" aria-label="Toggle menu">
