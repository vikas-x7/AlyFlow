      ...
      <div className="px-4 md:px-6 py-16 md:py-24 lg:py-32 mt-8 md:mt-20 lg:mt-75 ">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end gap-8 md:gap-12 lg:gap-0">
          <div className="flex-1 text-[#E5E5E5]">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl max-w-2xl m md:mb-8 leading-tight md:leading-13 -tracking-[2px] md:-tracking-[4px]">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 lg:gap-30">
              <p className="text-[#626262] max-w-xs text-xs sm:text-sm md:text-[13px] leading-relaxed ">
