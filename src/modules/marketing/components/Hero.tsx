      ...
      <section className="relative font-gothic min-h-screen flex flex-col">
        ...
        <div className="relative z-10 flex flex-col items-center text-center text-black flex-1 justify-center px-4 md:px-6 py-24 gap-7 mt-15">
          <div className="flex flex-col items-center gap-4">
            <h1
              className="text-3xl sm:text-4xl md:text-5xl lg:text-[64px] max-w-5xl 
            -tracking-[3px] md:-tracking-[4px] leading-18   font-instrument font-medium"
            >
              Design, connect, and organize <br /> every idea in one mind
            </h1>
            <p className="mx-auto text-xs sm:text-sm md:text-[19px] leading-6  text-[#171717] max-w-lg">
          ...
          <div className="flex gap-2">
            <Link
              href="/canvas"
              className="bg-[#171717] text-white px-5 md:px-6 py-2 text-xs sm:text-[15px] font-medium whitespace-nowrap rounded-[33px] transition hover:bg-black/80"
            >
              Get started now
            </Link>
            <Link
              href="/canvas"
              className="bg-[#dfdfdf] text-black px-5 md:px-6 py-2 text-xs sm:text-[15px] font-medium whitespace-nowrap rounded-[33px] transition hover:bg-black/80"
            >
              See demo
            </Link>
          </div>
          ...
          <div className="relative w-full max-w-7xl mx-auto mt-40 px-6 ">
            <img
